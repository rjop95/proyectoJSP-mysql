...
@WebServlet("/ConsultaGeneralClientes")
public class ConsultaGeneralClientes extends HttpServlet {
   	...
   	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
   		...
   		{/*
   			...
   			*/
   			...
   			salida.println("Campo IdCliente: " +rs.getInt("IdCliente"));
   			salida.print("Campo nombre Cliente: " +rs.getString("NombreCliente"));
   			salida.println("<br/>");
